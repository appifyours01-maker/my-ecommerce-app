...
void main() async { WidgetsFlutterBinding.ensureInitialized(); await dotenv.load(fileName: ".env"); runApp(const MyApp()); }
...
class ApiConfig {
  ...
  static const String adminObjectId = '6a6e0dacfcc119b7716aa830'; // Will be replaced during publish
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildCartPage() {
    return Scaffold(
      floatingActionButton: FloatingActionButton(heroTag: 'home_chatbot_fab', 
        onPressed: () {
          final shop = (SessionManager.appName ?? 'My Store').toString();
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => ChatBotPage(shopName: shop, appName: shop),
